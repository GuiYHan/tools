# Dump Analysis
Source :https://cqureacademy.com/blog/forensics/memory-dump-analysis


To perform a dump use DumpIt on the computer. This will create a Full Kernel Dump which basically is the size of that computer's memory.


To analyze this dump use either mimikaz or volatility
...
volatility_2.6.exe -f C:/example.dump --profile=[computer] [command]
